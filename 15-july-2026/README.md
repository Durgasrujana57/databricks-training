...
> **Note:** MySQL does not support `FULL JOIN` directly. In this project, FULL JOIN queries are implemented using `LEFT JOIN`, `RIGHT JOIN`, and `UNION`.
...
**Project:** SQL JOIN Practice (Basic & Intermediate)
